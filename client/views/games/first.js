Template.first.first = function() {
    ...
    function preload() {
        ...
        game.load.image('platform', '/img/tutorial/platform.png');
    ...
    function create() {
        ...
        // Creating and adding stars to the game
    ...
    function update() {
        ...
        // Check to see if the player overlaps with any of the stars. If he does, call the collectStar function
